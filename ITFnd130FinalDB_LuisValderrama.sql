...
-- 2021-06-10,LuisValderrama,Created File
--***********************************************************************************************--
Begin Try
	Use Master;
...
--Enrollments Table: 1.UDF to get the CourseStartDate based on a CourseID, and 2.Table Constraints--
--1. UDF to get the CourseStartDate based on a CourseID--
Create Function dbo.fCourseStartDate
(@CourseID int)
Returns Date
As
 Begin
...
--This constraint checks that the SignupDate is before the CourseStartDate--
	Alter Table Enrollments
      Add Constraint ckSignupDateVsCourseStartDate
        Check(SignupDate < dbo.fCourseStartDate(CourseID));
End
Go
...
Create Procedure pInsCourses
 ...
 -- Desc: Insert Sproc
 -- Change Log: When,Who,What
 -- 2021-06-10, Luis Valderrama, Created Insert Sproc.
AS
 Begin
  Declare @RC Int = 0;
  Begin Try
